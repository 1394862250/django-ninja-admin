...
from app.setting.utils import get_setting
...
def render_template(request, template_path: str, context: dict = None):
    ...
    context.setdefault('site_name', get_setting('system.site_name', 'Django Ninja 管理平台'))
...
def login_view(request):
    ...
    context = {
        'auth_background': get_setting('ui.auth_background', ''),
    }
